---
name: run-experiment
description: Deploy and run ML experiments on local, remote, or Modal serverless GPU. Use when user says "run experiment", "deploy to server", or needs to launch training jobs.
